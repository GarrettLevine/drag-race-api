    ...
    render() {
        return (
            <section className="donate section">
                ...
                <p className="donate-text">‘No Key No Shade’ costs around $10 a month to run. Any support would be appreciated, henny.</p>
                <Button
                    className="button_full-width"
                    label="Donate"
                    submit
                    handleClick={() => {
                        var win = window.open("https://www.paypal.me/Garrettlevine", '_target');
                        win.focus();
                    }}
                />
            </section>
